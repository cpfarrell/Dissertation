...
DIRIN=/uscms_data/d2/farrell3/WorkArea/Final2012Analysis06Jan2012/CMSSW_5_3_7_patch4/src/SUSYBSMAnalysis/HSCP/test/ICHEP_Analysis/Results/EXCLUSION8TeV/
DIROUT=figures/muonly
...
cp $DIRIN/HQExclusionLog.pdf $DIROUT/

DIRIN=$PROJECT/ICHEP_Analysis/Results/EXCLUSIONCOMB
DIROUT=figures/muonly
cp $DIRIN/MOExclusionLog.pdf $DIROUT/MOExclusionRelLog.pdf
DIROUT=figures/tkmu
cp $DIRIN/MuExclusionLog.pdf $DIROUT/MuExclusionRelLog.pdf
DIROUT=figures/tkonly
cp $DIRIN/TkExclusionLog.pdf $DIROUT/TkExclusionRelLog.pdf
DIROUT=figures/multi
cp $DIRIN/HQExclusionLog.pdf $DIROUT/HQExclusionRelLog.pdf

DIRIN=$PROJECT/WithClusterCleaning/Results/Type4/
DIROUT=figures/multi/
