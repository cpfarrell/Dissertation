...
(GeV) & \multicolumn{3}{c|}{$\sqrt{s}=8TeV$} & \multicolumn{2}{c|}{$\sqrt{s} = 8 TeV$} \\
      & Eff. & Obs. & Exp. & Obs. & Exp. \\
\hline
\endfirsthead
\multicolumn{6}{c}%
...
(GeV) & Req. & \multicolumn{3}{c|}{$\sqrt{s}=8TeV$} & \multicolumn{2}{c|}{$\sqrt{s} = 7 + 8 TeV$} \\
...
\endfoot
\endlastfoot
 \multicolumn{7}{|c|}{GMSB Stau ~~~-~~~ \tktof\ analysis} \\ \hline
...
\hline
Mass  & \multicolumn{3}{c|}{$\sigma (pb)$} & \multicolumn{2}{c|}{$\mu = \sigma/\sigma_{TH}$} \\
(GeV) & \multicolumn{3}{c|}{$\sqrt{s}=8TeV$} & \multicolumn{2}{c|}{$\sqrt{s}= 7 + 8 TeV$} \\
      & Eff. & Obs. & Exp. & Obs. & Exp. \\
\hline
\endfirsthead
\multicolumn{6}{c}%
...
The \tkonly\ analysis excludes f=10\% gluino production for masses below 1320 (1239) GeV in the cloud interaction (charge suppression) model. 
